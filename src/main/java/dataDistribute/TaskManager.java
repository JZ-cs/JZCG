...
public class TaskManager {
    ...
    public int me;
    public int masterID;
    public TaskManager(ServerInfo[] serverInfoList, int me, int masterID){
    ...
    public TaskManager(ServerInfo[] serverInfoList, int me, int masterID, TrainingInfo[] trainingInfos){
        this.serverInfoList = serverInfoList;
        this.me = me;
        this.masterID = masterID;
